...
<body>
	...
	<div class="content">
		<div class="left">
			...
			</a> <a class="plain-a" href="/allOrders">
		...
		<div class="right">
			<div>
				<span class="theading">Add New Product</span>
			</div>
			...
			<div>
				<form action="/addProduct" method="post">
					<div>
						...
						<input type="text" class="text-input" name="productName">
					</div>
					<div>
						<span>Product Description</span>
						<input type="text" class="text-input" name="description">
					</div>
					<div>
						<span>Product Price</span>
						<input type="text" class="text-input" name="price">
					</div>
					<div>
